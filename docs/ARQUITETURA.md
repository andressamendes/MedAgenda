...
>
> Este arquivo e `ARCHITECTURE.md` coexistiam com conteúdo parcialmente sobreposto e divergente (duplicação PT/EN identificada em `AUDITORIA_TECNICA_F9.md`). Para evitar documentação divergente, seu conteúdo não é mais mantido aqui.
