 ...
 */
export async function getWeeklySummary(allBaseEvents) {
 ...
 * @returns {Promise<string>}
 */
export async function getStudySuggestion(allBaseEvents) {
 ...
 * @returns {Promise<string>}
 */
export async function getScheduleAnalysis(allBaseEvents) {
